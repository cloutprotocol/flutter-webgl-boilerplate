...
class AstroScreen extends StatelessWidget {
  const AstroScreen({Key? key}) : super(key: key);
  static const String routeName = '/astro';

  static Route route(){
    return MaterialPageRoute(
      builder: (_) => AstroScreen(),
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: AstroScreenView(),
    );
  }
}

class AstroScreenView extends StatefulWidget {
  const AstroScreenView({Key? key}) : super(key: key);

  @override
  _AstroScreenViewState createState() =>
      _AstroScreenViewState();
}

class _AstroScreenViewState
    extends State<AstroScreenView> {
